...
const productImages = [
    ...
    'Yellow2.png', 
    'white2.png',
    'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="500" height="500"><rect width="500" height="500" fill="%23fce4ec" rx="10"/></svg>',
    'data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="500" height="500"><rect width="500" height="500" fill="%23d1ecf1" rx="10"/></svg>'
];
